...
def writeScripts():
    ...
    png(paste(phenotype, "_total_netNodes.pdf", sep=""), heigh=720, width=1280)
    ...
    png(paste(phenotype, "_total_netLinks.pdf", sep=""), heigh=720, width=1280)
    ...
    png(paste(phenotype, "_largest_netNodes.pdf", sep=""), heigh=720, width=1280)
    ...
    png(paste(phenotype, "_largest_netLinks.pdf", sep=""), heigh=720, width=1280)
